...
const Questions:QuestionsArray[][][] = [
  [
     [
      ...
      { Question: 'Escolha a separação silábica correta ?', QuestionType:'OnlySelectQuestionWithImage', QuestionImg: '', Answer: 1, Alternatives: [['Ge-la-tina', Objetos.Gelatina],['Ge-la-dei-ra', Objetos.Geladeira], ['Al-moço', Objetos.Almoço], ['Milh-o', Objetos.Milho]] },
